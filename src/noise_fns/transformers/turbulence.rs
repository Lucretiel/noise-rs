...
impl<Source: Default> Default for Turbulence<Source> {
    fn default() -> Self {
        Self::new(Source::default())
    }
}

impl<Source: NoiseFn<Point2<f64>>> NoiseFn<Point2<f64>> for Turbulence<Source> {
...
impl<Source: NoiseFn<Point3<f64>>> NoiseFn<Point3<f64>> for Turbulence<Source> {
...
impl<Source: NoiseFn<Point4<f64>>> NoiseFn<Point4<f64>> for Turbulence<Source> {
